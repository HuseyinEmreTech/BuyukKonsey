      ...
      <div className="sidebar-footer">
        ...
        <div className="sidebar-control">
          <button className="theme-toggle-btn" onClick={toggleTheme}>
            ...
            <span style={{ marginLeft: '4px' }}>{theme === 'dark' ? t('sidebar.light') : t('sidebar.dark')}</span>
          </button>
        </div>
        <div className="sidebar-control">
          <button
          ...
          >
            ...
            <span style={{ marginLeft: '4px' }}>{language === 'tr' ? t('sidebar.langNameTr') : t('sidebar.langNameEn')}</span>
          </button>
        </div>
      </div>
    </div>
