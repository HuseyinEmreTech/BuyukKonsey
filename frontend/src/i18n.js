const translations = {
  en: {
    ...
    'settings.councilTable': 'Grand Council Table',
    'settings.premiumKadro': 'Premium Cadre',
    'settings.premiumKadroTitle': 'Builds the council with the most powerful models.',
    'settings.freeKadro': 'Free Cadre',
    'settings.freeKadroTitle': 'Builds the council with the best free models — zero cost.',
  ...
  tr: {
    ...
    'settings.councilTable': 'Büyük Konsey Masası',
    'settings.premiumKadro': 'Premium Kadro',
    'settings.premiumKadroTitle': 'Konseyi en güçlülerle kurar.',
    'settings.freeKadro': 'Ücretsiz Kadro',
    'settings.freeKadroTitle': 'Konseyi en iyi ücretsiz modellerle kurar — sıfır maliyet.',
