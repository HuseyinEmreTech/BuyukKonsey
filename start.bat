...
REM Windows'ta 8001 ve 5173 portlarini dinleyen islemleri oldur (Uyarilari gizler)
...
REM Backend'i arka planda baslatmak icin yeni pencerede minimal baslatacagiz.
...
REM Dev sunucuyu bu konsolda baslat (Uygulama buradan kapanacak)
npm run dev
